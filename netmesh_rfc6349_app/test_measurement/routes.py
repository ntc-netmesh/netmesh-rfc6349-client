...
@test_measurement.route('/get-admin-credentials-template', methods=['POST'])
def get_admin_credentials_template():
    return render_template('device_admin_credentials.html')


@test_measurement.route('/log-admin', methods=['POST'])
def log_admin():
...
@test_measurement.route('/get-device-details-template', methods=['POST'])
...
@test_measurement.route('/device-confirmation-template', methods=['POST'])
...
@test_measurement.route('/device-details', methods=['GET'])
def device_details():
