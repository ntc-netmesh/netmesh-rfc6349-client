...
Icon={app_name}
Categories=Application;
Exec=bash -c "pkexec {INSTALLED_DIRECTORY}/{app_name}";
""")
    f.close()

#   pkexec_file_path = f'{MAIN_DIRECTORY}/dist/{app_name}-pkexec'
#   pkexec_file_action = 'x'

#   if os.path.isfile(pkexec_file_path):
#     pkexec_file_action = 'w'

#   with open(pkexec_file_path, pkexec_file_action) as f:
#     f.write(f"""#!/bin/sh
# pkexec '{INSTALLED_DIRECTORY}/{app_name}' '$@'
# """)
#     f.close()
