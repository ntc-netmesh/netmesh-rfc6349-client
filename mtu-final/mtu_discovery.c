...
int main(int argc, char** argv)
{
    ...
    while (1){
    	...
    	n = recvfrom(sockfd, (char*) buffer, 65536, MSG_WAITALL, (struct sockaddr*) &dst, &len);
    	buffer[n] = '\0';
    ...
    recvfrom(sockfd, (char*) buffer, 65536, MSG_WAITALL, (struct sockaddr*) &dst, &len);
    printf("server: %s\n", buffer);
	/*
